<h1 class="mt-6 md:mt-16 font-concert-one text-2xl sm:text-4xl hsm:text-5xl md:text-6xl text-dark-green dark:text-peach tracking-1 mx-auto w-4/5">
    🎉 Installation Successful! 🎉
</h1>

<section class="m-auto w-11/12 mt-24">
    <h2 class="font-concert-one text-2xl sm:text-4xl text-dark-green dark:text-peach tracking-1 ml-2 sm:ml-6 md:ml-8 mt-16">
